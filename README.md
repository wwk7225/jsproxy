...
```bash
curl https://raw.githubusercontent.com/wwk7225/jsproxy/0.1.0/i.sh | bash
```
...
```bash
curl https://raw.githubusercontent.com/wwk7225/jsproxy/master/i.sh | bash -s example.com
```
